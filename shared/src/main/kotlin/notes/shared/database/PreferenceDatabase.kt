...
class PreferenceDatabase {
    ...
    private class Database {
        ...
        private fun createTableIfNotExists() {
            ...
            val setDefaultPreferencesIfTableEmptySQL = "INSERT INTO preferences (x, y, width, height, dividerPos, isListCollapsed, theme ) SELECT 0.0, 0.0, 600.0, 400.0, 0.3, 0, 'LIGHT' WHERE NOT EXISTS (SELECT 1 FROM preferences);"
